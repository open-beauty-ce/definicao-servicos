...
var ValidationErrorFilter = /** @class */ (function () {
    ...
    ValidationErrorFilter.prototype.catch = function (exception, host) {
        throw new microservices_1.RpcException({ code: common_2.Common.GrpcStatus.INVALID_ARGUMENT, message: exception.errors[0].message });
    };
